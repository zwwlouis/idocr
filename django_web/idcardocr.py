...
def get_birth(year, month, day):
        ...
        return pytesseract.image_to_string(year_red, lang='idnum', config='-c tessedit_char_whitelist=0123456789 -psm 13').replace(" ",""), \
               pytesseract.image_to_string(month_red, lang='idnum', config='-c tessedit_char_whitelist=0123456789 -psm 13').replace(" ",""), \
               pytesseract.image_to_string(day_red, lang='idnum', config='-c tessedit_char_whitelist=0123456789 -psm 13').replace(" ","")
